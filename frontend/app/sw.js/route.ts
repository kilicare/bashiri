...
export async function GET() {
  const firebaseConfig = {
    ...
    authDomain: process.env.NEXT_PUBLIC_FIREBASE_AUTH_DOMAIN || 'YOUR_FIREBASE_PROJECT.firebaseapp.com',
    projectId: process.env.NEXT_PUBLIC_FIREBASE_PROJECT_ID || 'YOUR_FIREBASE_PROJECT',
    messagingSenderId: process.env.NEXT_PUBLIC_FIREBASE_SENDER_ID || 'YOUR_SENDER_ID',
