...
import { ShareSheet } from "@/components/predictions/ShareSheet";
    ...
    <div className="px-5 pt-safe pt-6 pb-8">
      <div className="flex items-center justify-between mb-5">
        ...
        <div className="flex gap-2">
          <button onClick={handleSave} disabled={saving} className="w-9 h-9 rounded-xl flex items-center justify-center bg-white/5">
            {saving ? (
