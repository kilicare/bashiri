  ...
  return (
    <button
      ...
      className={clsx(
        ...
        selected
          ? "border-[var(--brand-primary)] bg-gradient-to-br from-[var(--brand-primary)]/20 to-[var(--brand-accent)]/10 shadow-[0_0_30px_rgba(212,175,55,0.4)] scale-[1.02]"
    ...
    >
      ...
      {/* Animated checkmark */}
      {selected && (
        <div className="absolute top-1.5 right-1.5 md:top-2 md:right-2 w-5 h-5 md:w-6 md:h-6 bg-gradient-to-br from-[var(--brand-primary)] to-[var(--brand-accent)] rounded-full flex items-center justify-center shadow-lg">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center gap-1.5 md:gap-2 h-full">
        ...
        <div
          className={clsx(
            ...
            selected ? "shadow-[0_0_20px_rgba(212,175,55,0.4)]" : "shadow-md"
          )}
          style={{
        ...
        <div className="text-center">
          ...
          {selected && (
            <div className="text-[10px] md:text-xs text-[var(--brand-primary)]/80 font-medium mt-0.5">Favorite</div>
          )}
        </div>
      </div>
    </button>
