        ...
        <div className="p-5">
          <div className="flex items-start justify-between gap-3">
            ...
            <div className="flex items-center gap-2">
              <PremiumBadge variant={isElite ? "green" : isStrong ? "gold" : hasEdge ? "gold" : "red"}>
                {isElite ? "Elite" : isStrong ? "Strong" : hasEdge ? "Edge" : "Low"}
              </PremiumBadge>
          ...
          <div className="mt-5 flex items-center gap-3 text-xs" style={{ color: "var(--text-secondary)" }}>
            <div className="flex items-center gap-1.5">
              <TrendingUp 
                className={clsx("h-3.5 w-3.5", isElite || isStrong ? "text-[var(--brand-accent)]" : hasEdge ? "text-[var(--warning)]" : "text-[var(--danger)]")} 
                style={isElite || isStrong ? { color: "var(--brand-accent)" } : hasEdge ? { color: "var(--warning)" } : { color: "var(--danger)" }}
              />
